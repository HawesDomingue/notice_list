...
ALTER TABLE NL_MEMBERS ADD CONSTRAINT NL_MEMBERS_EXCL_FK CHECK (NOTICE_LISTS_NOTICE_LIST_ID IS NOT NULL AND ACTIVE_EMPLOYEES_EMPLOYEE_ID IS NULL OR NOTICE_LISTS_NOTICE_LIST_ID IS NULL AND ACTIVE_EMPLOYEES_EMPLOYEE_ID IS NOT NULL) ;
